...
[![JCenter](https://img.shields.io/badge/%20JCenter%20-2.0.3-5bc0de.svg?style=flat-square)](https://bintray.com/xuehuayous/maven/DelegationAdapter/_latestVersion)
...
```
implementation 'com.kevin:delegationadapter:2.0.3'
// 扩展库，扩展支持了item click、item long click、databinding、load more
implementation 'com.kevin:delegationadapter-extras:2.0.3'
```
