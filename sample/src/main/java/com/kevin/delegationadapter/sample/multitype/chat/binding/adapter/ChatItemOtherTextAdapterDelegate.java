...
/**
 * ChatItemOtherTextAdapterDelegate
 *
...
public class ChatItemOtherTextAdapterDelegate extends BindingAdapterDelegate<Chat.TalkMsg> {
    ...
    public int getLayoutRes() {
        return R.layout.item_chat_other_text_binding;
    }

    @Override
    public void setVariable(@NonNull ViewDataBinding binding, Chat.TalkMsg item, int position) {
